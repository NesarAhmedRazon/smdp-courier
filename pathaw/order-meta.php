...
if(!function_exists('consignment_metas')){
    ...
    function consignment_metas($order){ 
        ...
        echo '<div class="form-field form-field-wide"> <label for="pathao_pkg_weight">' . __('Package Weight', 'SMDP_TEXTDOMAIN') . ':</label> <input type="text" id="pkg_weight" name="pkg_weight" value="' . esc_attr($pkg_weight) . '" class="pathao-auto-save"> </div>';
        echo '<div class="form-field form-field-wide"> <label for="pathao_pkg_qty">' . __('Package Quantity', 'SMDP_TEXTDOMAIN') . ':</label> <input type="text" id="pkg_qty" name="pkg_qty" value="' . esc_attr($pkg_qty) . '" class="pathao-auto-save"> </div>';
        echo '<div class="form-field form-field-wide s"> <label for="pathao_pkg_desc">' . __('Package Description', 'SMDP_TEXTDOMAIN') . ':</label> <input type="text" id="pkg_desc" name="pkg_desc" value="' . esc_attr($package_desc) . '" class="pathao-auto-save"> </div>';
    }
}
...
function add_pathao_address_fields($order){
    ...
    ?>
    <!-- <div class="pathao-address-section"><h4 style="margin-top:0;"><?php _e('Pathao Delivery Information', 'SMDP_TEXTDOMAIN'); ?></h4><div class="">s</div></div> -->
    <div class="pathao-address-section">
        <h4 style="margin-top:0;"><?php _e('Pathao Delivery Information', 'SMDP_TEXTDOMAIN'); ?></h4>
        
        <!-- City Selection -->
        <div class="form-field form-field-wide">
            <label for="pathao_city"><?php _e('City', 'SMDP_TEXTDOMAIN'); ?>:</label>
            <select id="pathao_city" name="pathao_city" class="pathao-location-select" data-order-id="<?php echo $order_id; ?>" data-level="city">
                <option value=""><?php _e('Loading cities...', 'SMDP_TEXTDOMAIN'); ?></option>
            </select>
        ...
        <!-- Zone Selection -->
        <div class="form-field form-field-wide">
            <label for="pathao_zone"><?php _e('Zone', 'SMDP_TEXTDOMAIN'); ?>:</label>
            <select id="pathao_zone" name="pathao_zone" class="pathao-location-select" data-order-id="<?php echo $order_id; ?>" data-level="zone" disabled>
                <option value=""><?php _e('Select city first', 'SMDP_TEXTDOMAIN'); ?></option>
            </select>
        ...
        <!-- Area Selection -->
        <div class="form-field form-field-wide">
            <label for="pathao_area"><?php _e('Area', 'SMDP_TEXTDOMAIN'); ?>:</label>
            <select id="pathao_area" name="pathao_area" class="pathao-location-select" data-order-id="<?php echo $order_id; ?>" data-level="area" disabled>
                <option value=""><?php _e('Select zone first', 'SMDP_TEXTDOMAIN'); ?></option>
            </select>
        ...
        <!-- Consignment ID -->
        <div class="form-field form-field-wide">
            <label for="pathao_consignment_id"><?php _e('Pathao Consignment ID', 'SMDP_TEXTDOMAIN'); ?>:</label>

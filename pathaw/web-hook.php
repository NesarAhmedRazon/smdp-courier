...
function pathao_webhook_callbackd(WP_REST_Request $request) {
    ...
    logging([
        ...
        // 'signature' => $pathaw_signature,
        'valid_signature' => $pathaw_signature === $webhook_secret,
        'payload' => $body,
    ], 'pathao_webhook_log.json');
